...
| 중간 | 바둑 단수쳐도 손해인 돌은 어떻게 구분할까 | 단수와 포획은 보이지만 잡아도 손해인 작은 돌을 구분하고 싶은 초보 검색 | `baduk-profitable-capture.html`, `baduk-atari.html`, `baduk-save-or-sacrifice.html`, `baduk-sacrifice-moments.html` |
