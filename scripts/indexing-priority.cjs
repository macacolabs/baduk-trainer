...
const corePaths = new Map([
  ...
  ["baduk-rank-roadmap.html", { score: 108, reason: "바둑 급수표 검색 글" }],
  ["baduk-beginner-mistakes.html", { score: 107, reason: "바둑 초보 실수 검색 글" }],
  ...
  ["omok-block-four.html", { score: 106, reason: "오목 4목 차단 검색 글" }],
